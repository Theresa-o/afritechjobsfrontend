...
const Hero = () => {
  return (
    <section>
      <div className="container mx-auto flex justify-center items-center flex-col my-20 md:my-24">
        ...
        <h2 className="text-center mt-2 md:mt-5 text-xl">
          Your Gateway to Tech Careers with Limitless Possibilities
        </h2>
        <p className="text-center mt-1 md:mt-2 text-xl">
